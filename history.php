...
<body>
  ...
  <select name="column" id="column" class="btn btn-secondary dropdown-toggle filter-btn1 ">
      ...
      <option value="RentID">Rent ID</option>
			<option value="DateRequested">Date Requested "Year-Month-Day"</option>
			<option value="DateRented">Date Rented "Year-Month-Day"</option>
      <option value="ReturnDate">Return Date "Year-Month-Day"</option>
		</select>
	</form>
...
if (isset($_POST['search'])) {
  ...
  if ($search == "all") {
    ...
    $sql = "SELECT * FROM history WHERE $column LIKE '%$search%'";
  }
...
if ($result->num_rows > 0) {
  echo "<div class='table-responsive'>";
    ...
    echo "<th scope='col'>DateRequested</th>";
