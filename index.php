      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2000">
        <div class="carousel-inner">
          <div id="carousel-item-1" class="carousel-item active">
            ...
            <a id="learn1-button" class="btn btn-sm btn-outline-none position-relative top-1 bottom-1" href="carscat.php#luxury">Learn More</a>
          </div>
          </div>
          <div class="carousel-inner">
          <div id="carousel-item-2" class="carousel-item active">
            ...
            <a id="learn1-button" class="btn btn-sm btn-outline-none position-relative top-1 bottom-1" href="carscat.php#Sports">Learn More</a>
          </div>
          </div>
