...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="col-md-6">
      ...
      <form action="carhis.php" method="post">
      <input type="submit" name="history" value="view history" class="btn btn-outline-light btn-lgpx-3">
</form>
      ...
      <p>After submitting a car rental request, please note that there will be a one-day waiting period before going to the main branch to complete the rental transaction.<br>
Present Rental ID and Drivers License to the staff in order to proceed in renting the car.</p>
    </div>
...
if ($result->num_rows > 0) {
  echo "<div class='table-responsive'>";
    ...
    echo "<th scope='col'>Cancel(within the day only)</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td><a href='cancelrent.php?RentID=" . $row["RentID"] . "' class='btn btn-danger ml-2'>Cancel</a></td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table> 
