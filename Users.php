...
<body>
    ...
    <nav class="navbar navbar-expand-sm custom-navbar" data-bs-theme="dark">
        <div class="container-fluid">
          ...
          <a type="button" name="search" value="Search by ID" class="btn btn-sm btn-outline-none custom-btn" href="searchUser.php">Search by ID</a>
          </div>
          
          <form action="logoutadmin.php" method="post">
          <div class="button-container">
            <input type="submit" name="logoutadmin" value="Logout" class="btn btn-sm btn-outline-none custom-btn" >
          </div>
          </form>
